...
import type { ResponderStackParamList, Incident, IncidentType } from "../../navigation/ResponderNavigator"
...
const MOCK_INCIDENTS: Incident[] = [
  ...
  },
  {
    id: "3",
    title: "Fire Reported",
    description: "Small fire in residential building, spreading to nearby structures",
    location: {
...
const DashboardScreen = () => {
  ...
  useEffect(() => {
    console.log("Default location set to Socorro, Oriental Mindoro:", SOCORRO_COORDINATES)
  }, [])
  ...
  const filterIncidents = (type: string | null, filterId: string): void => {
    console.log("Filtering incidents by type:", type, "with filter ID:", filterId)
  ...
  const getFilteredIncidents = (): Incident[] => {
    if (!selectedIncidentType) return incidents
    return incidents.filter((incident) => incident.type?.name === selectedIncidentType)
  }
    ...
    >
      <View style={styles.cardHeader}>
        <View style={styles.cardTitleContainer}>
          <View style={[styles.incidentTypeIndicator, { backgroundColor: item.type?.color || "#2C74B3" }]} />
      ...
      >
        ...
        <Callout tooltip>
          <View style={styles.calloutContainer}>
            ...
            <Text style={styles.calloutAddress}>{incident.location.address}</Text>
            <View style={styles.calloutFooter}>
              <Text style={styles.calloutTime}>{formatTime(incident.timestamp)}</Text>
  ...
  const renderFilterChips = () => {
    ...
    return (
      <View style={styles.filterContainer}>
        <ScrollableChips
          items={[{ id: "all", label: "All", icon: "filter-variant" }, ...incidentTypes]}
  ...
  const ScrollableChips = ({
    ...
    items: Array<{ id?: string; name?: string; label?: string; icon: string; color?: string }>
        ...
        return (
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              const itemValue = item.id === "all" ? null : item.name || item.label || null
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <View style={styles.headerTitleContainer}>
            <MaterialCommunityIcons name="bell-ring-outline" size={22} color="#2C74B3" style={styles.headerIcon} />
            <Text style={styles.headerTitle}>Incoming Reports</Text>
          </View>
          <TouchableOpacity style={styles.viewToggle} onPress={toggleViewMode} testID="view-toggle-button">
            <MaterialCommunityIcons
        ...
        {loading ? (
          ...
          <FlatList
            ...
            refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={["#2C74B3"]} />}
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <MaterialCommunityIcons name="alert-circle-outline" size={48} color="#144272" />
          ...
          <View style={styles.mapContainer}>
            ...
            <View style={styles.mapOverlay}>
              ...
              <TouchableOpacity style={styles.mapButton} onPress={centerMapOnSocorro}>
